<style>
.product-grid > div{ width:196px!important; }
.product-grid > div:nth-child(4n){ border-right: 1px solid lightgray!important; }
.product-grid > div:nth-child(5n){ border:none; }
</style>
<?php echo $header; ?>
<div class="wrapper">
 ...
 <!-- <div class="breadcrumb">
  ...
  <div class="product-grid">
    ...
    <div>
      ...
      <div class="description" style="width:800px;"><?php echo $product['description']; ?></div>
      ...
      <div class="item_language"><font color="grey"><b><?php echo $product['item_language']; ?></b></font></div>
      <?php } ?>-->
      <div class="cart">
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list > div').each(function(index, element) {
			...
			html += '  <div class="description" style="width:800px;">';
