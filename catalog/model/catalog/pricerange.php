<?php
class ModelCatalogPricerange extends Model {
	...
	public function getProducts($data = array()) {
		...
		if((!empty($data['pricerange_low'])) ){
			$sql .= " AND p.price>=".$data['pricerange_low'];
		}
		if((!empty($data['pricerange_high'])) ){
			$sql .= " AND p.price<=".$data['pricerange_high'];
		}
