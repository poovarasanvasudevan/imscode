...
$_['text_mysrcm']          = 'If you already have an account at <a href="http://profile.sahajmarg.org">MySRCM</a> (<a>http://profile.sahajmarg.org</a>) - please use the same email address to register here. This will help with smooth migration when SHPT.in integrates with MySRCM for authentication.';
