...
$responseURL="responseURL=https://shpt.in/hdfcpg/GetHandleRESponse.php";
...
*/ 
$errorURL="errorURL=https://shpt.in/hdfcpg/FailedTRAN.php";
...
echo '<script type="text/javascript">alert("Inside paymentDirect method !!!!");</script>';
