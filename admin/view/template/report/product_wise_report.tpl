    ...
    <div class="content">
      <table class="form">
        <tr>
		  ...
		  <!--
		  <a onclick="filter('excelexport');" class="button"><?php echo $button_export; ?></a></td>  -->
...
function filter() {
	url = 'index.php?route=report/product_wise_report&token=<?php echo $token; ?>';
...
function excelexport() {
	alert("hi");
	url = 'index.php?route=report/product_wise_report/excelreport&token=<?php echo $token; ?>';
