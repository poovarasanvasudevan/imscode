        ...
        <div class="content">
            <table class="form">
                <tr>
                    ...
                    <td style="text-align: right;"><a onclick="filter();"
                                                      class="button"><?php echo $button_filter; ?></a>&nbsp;
            ...
            <table class="list">
                ...
                <tr>
                    ...
                    -->
                    <td class="left"><?php echo $customer['shipping_firstname'] . ' ' . $customer['shipping_lastname']; ?></td>
                    ...
                    <td class="left"><?php echo $customer['price']; ?></td>
...
<script type="text/javascript"><!--
    function filter() {
        url = 'index.php?route=report/customer_wise_order_report&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
    function excelexport() {
        alert("hi");
        url = 'index.php?route=report/customer_wise_order_report/excelreport&token=<?php echo $token; ?>';
