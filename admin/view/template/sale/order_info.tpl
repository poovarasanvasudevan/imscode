                ...
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td><?php if ($invoice_no) { ?>
                            ...
                            <?php } else { ?>
                            <span id="invoice"><b>[</b>
                                <!--<a id="invoice-generate"> --> <?php echo $text_generate; ?></a> <b>]</b></span>
                            <?php } ?></td>
                    </tr>
                    <tr>
            ...
            <div id="tab-history" class="vtabs-content">
                ...
                <table class="form">
                    <tr>
                        ...
                        <td>
                            <input type="hidden" name="old_order_status_id" value="<?php echo $order_status_id; ?>"
                                   id="old_order_status_id"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="weight" value="<?php echo $order_weight; ?>" id="weight"> &nbsp;&nbsp;
                            <a class="button" id="button-save"><?php echo $button_save; ?></a>
...
<script type="text/javascript"><!--
    ...
    $('#button-save').live('click', function () {
        ...
        //updateweight
        $.ajax({
            url: 'index.php?route=sale/order/updateweight&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>' + '&order_weight=' + weight,
            type: 'get',
            dataType: 'json',
            beforeSend: function () {
                $('.success, .warning').remove();
...
<script type="text/javascript"><!--
    function orderStatusChange() {
        ...
        $.ajax({
            url: 'index.php?route=extension/openbay/ajaxOrderInfo&token=<?php echo $this->request->get['
            token']; ?>&order_id=<?php echo $this->request->get['
