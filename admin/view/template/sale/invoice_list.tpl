        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'o.order_id') { ?>
                ...
                <td class="left">
                    <a href="<?php echo $column_date_added; ?>"><?php echo $column_date_added; ?></a>
                </td>

                <td class="left">
                    <a href="<?php echo $column_date_added; ?>"><?php echo $column_status; ?></a>
                </td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php echo $invoice['date']; ?></td>
              <td class="right"><?php echo $invoice['order_status']; ?></td>
