  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a onclick="$('#form').attr('action', '<?php echo $complete; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="button"><?php echo $button_complete; ?></a>
          <a onclick="$('#form').attr('action', '<?php echo $update; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="button"><?php echo $button_update; ?></a>
      </div>
    </div>
    <div class="content">
