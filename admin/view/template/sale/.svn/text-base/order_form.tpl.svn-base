...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $tab_customer; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a><a href="#tab-shipping"><?php echo $tab_shipping; ?></a><a href="#tab-product"><?php echo $tab_product; ?><a href="#tab-invoice"><?php echo $tab_invoice; ?></a><a href="#tab-voucher"><?php echo $tab_voucher; ?></a><a href="#tab-total"><?php echo $tab_total; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-invoice" class="vtabs-content">
          <table class="list">
            <thead>
              <tr>
                ...
                <td class="right"><?php echo $column_shp_quantity; ?></td>
                <td class="right"><?php echo $column_inv_quantity; ?></td>
            ...
            <?php $download_row = 0; ?>
            <tbody id="invoice">
              <?php if ($order_invoices) { ?>
              <?php foreach ($order_invoices as $order_invoice) { ?>
              <tr id="product-row<?php echo $product_row; ?>">
                <td class="left"><?php echo $order_invoice['name']; ?><br />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_product_id]" value="<?php echo $order_invoice['order_product_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][product_id]" value="<?php echo $order_invoice['product_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][name]" value="<?php echo $order_invoice['name']; ?>" />
                  <?php foreach ($order_invoice['option'] as $option) { ?>
                  - <small><?php echo $option['name']; ?>: <?php echo $option['value']; ?></small><br />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][order_option_id]" value="<?php echo $option['order_option_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][product_option_id]" value="<?php echo $option['product_option_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][product_option_value_id]" value="<?php echo $option['product_option_value_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][name]" value="<?php echo $option['name']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][value]" value="<?php echo $option['value']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][type]" value="<?php echo $option['type']; ?>" />
                  <?php $option_row++; ?>
                  <?php } ?>
                  <?php foreach ($order_invoice['download'] as $download) { ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][order_download_id]" value="<?php echo $download['order_download_id']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][name]" value="<?php echo $download['name']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][filename]" value="<?php echo $download['filename']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][mask]" value="<?php echo $download['mask']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][remaining]" value="<?php echo $download['remaining']; ?>" />
                  <?php $download_row++; ?>
                  <?php } ?></td>
                <td class="left"><?php echo $order_invoice['model']; ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][model]" value="<?php echo $order_invoice['model']; ?>" /></td>
                <td class="right"><?php echo $order_invoice['quantity']; ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][quantity]" value="<?php echo $order_invoice['quantity']; ?>" /></td>
                <td class="right"><?php echo $order_invoice['shp_quantity']; ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][shp_quantity]" value="<?php echo $order_invoice['shp_quantity']; ?>" /></td>
                <td class="right">
                  <input type="text" name="order_invoice[<?php echo $product_row; ?>][inv_quantity]" <?php echo $order_invoice['disabled'];?> size="5" maxlength="5" value="" />
                  <?php if ($error_inv_quantity) { ?>
                  <span class="error"><?php echo $error_inv_quantity; ?></span>
                <?php } ?>
                  </td>
                <td class="right"><?php echo $order_invoice['price']; ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][price]" value="<?php echo $order_invoice['price']; ?>" /></td>
                <td class="right"><?php echo $order_invoice['total']; ?>
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][total]" value="<?php echo $order_invoice['total']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][tax]" value="<?php echo $order_invoice['tax']; ?>" />
                  <input type="hidden" name="order_invoice[<?php echo $product_row; ?>][reward]" value="<?php echo $order_invoice['reward']; ?>" /></td>
              </tr>
              <?php $product_row++; ?>
              <?php } ?>
              <?php } else { ?>
          ...
          <table class="list">
            <tfoot>
              <tr>
              	...
              	<a id="button-saveOrder" class="button" style='visibility:hidden'><?php echo $button_save_order; ?></a>
                <a id="button-invoice" class="button" style='visibility:hidden'><?php echo $button_gen_invoice; ?></a>
                </div>
              </tr>
            </tfoot>
          </table>
          <table class="list">
            ...
            <tbody id="invoices">
              <?php if ($order_invoices) { ?>
              <?php foreach ($order_invoices as $order_invoice1) { ?>
              <tr id="product-row<?php echo $product_row; ?>">
              	<?php if($row_span_flag < 1) { ?>
                	<td class="left" rowspan="<?php echo $row_span; ?>"><?php echo $order_invoice1['invoice_no']; ?><br />
                <?php $row_span_flag++; ?>
                <?php } ?>
                <td class="left"><?php echo $order_invoice1['name']; ?>
                  <input type="hidden" name="order_invoice1[<?php echo $product_row; ?>][model]" value="<?php echo $order_invoice1['model']; ?>" /></td>
                <td class="right"><?php echo $order_invoice1['shp_quantity']; ?>
                  <input type="hidden" name="order_invoice1[<?php echo $product_row; ?>][quantity]" value="<?php echo $order_invoice1['quantity']; ?>" /></td>
                <td class="right">0
                  <input type="hidden" name="order_invoice1[<?php echo $product_row; ?>][inv_quantity]" value="<?php echo $order_invoice1['inv_quantity']; ?>" /></td>
                <td class="right"><?php echo $order_invoice1['price']; ?>
                  <input type="hidden" name="order_invoice1[<?php echo $product_row; ?>][price]" value="<?php echo $order_invoice1['price']; ?>" /></td>
                <td class="right"><?php echo $order_invoice1['total']; ?>
                  <input type="hidden" name="order_invoice1[<?php echo $product_row; ?>][total]" value="<?php echo $order_invoice1['total']; ?>" />
              </tr>
              <?php $product_row++; ?>
              <?php } ?>
              <?php } else { ?>
          ...
          <table class="list">
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="right"><?php echo $order_product['shp_quantity']; ?>
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][shp_quantity]" value="<?php echo $order_product['shp_quantity']; ?>" /></td>                 
...
//--></script> 
<script type="text/javascript"><!--
$('#button-product, #button-voucher, #button-update, #button-invoice, #button-saveOrder').live('click', function() {	
	...
	} else if ($(this).attr('id') == 'button-saveOrder') {
		saveInvoiceQuantity();
	} else if ($(this).attr('id') == 'button-invoice') {
		alert('inside button invoice ');
	} else {
...
//--></script> 
<script type="text/javascript"><!--
    function saveInvoiceQuantity(){
    	$.ajax({
			url: 'index.php?route=sale/order/partialInvoice&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
			type: 'post',
			data: $('input'),
			dataType: 'json',	
			beforeSend: function() {
				$('.success, .warning, .attention, .error').remove();
				$('#button-saveOrder').attr('disabled', true);
				$('.box').before('<div class="attention"><img src="view/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
			},
			complete: function() {
				$('#button-saveOrder').attr('disabled', false);
				$('.attention').remove();
			},			
			success: function(json) {
				$('#tab-invoice').json(json);
	    	}
    	});    	
	}
//--></script>
