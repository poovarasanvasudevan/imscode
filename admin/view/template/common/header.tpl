...
<div id="container">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
	  ...
	  <li><a href="<?php echo $invoicelist; ?>"><?php echo $text_invoicelist; ?></a></li>
        </ul>
      </li>
      ...
      <li id="reports"><a class="top"><?php echo $text_reports; ?></a>
        <ul>
          <li><a class="parent"><?php echo $text_SHPT_reports; ?></a>
            <ul>
            	<li><a href="<?php echo $report_order_status_report; ?>"><?php echo $text_report_order_status_report; ?></a></li>
            	<li><a href="<?php echo $report_customer_wise_report; ?>"><?php echo $text_report_customer_wise_report; ?></a></li>
            	<li><a href="<?php echo $report_product_wise_report; ?>"><?php echo $text_report_product_wise_report; ?></a></li>
            </ul>
          </li>
          <li><a class="parent"><?php echo $text_sale; ?></a>
            <ul>
              <li><a href="<?php echo $report_sales_order_details; ?>"><?php echo $text_report_sales_order_details; ?></a></li>
