      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_tin; ?></td>
              <td><input type="text" name="config_tin" value="<?php echo $config_tin; ?>" size="40" />
                <?php if ($error_tin) { ?>
                <span class="error"><?php echo $error_tin; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_cst; ?></td>
              <td><input type="text" name="config_cst" value="<?php echo $config_cst; ?>" size="40" />
                <?php if ($error_cst) { ?>
                <span class="error"><?php echo $error_cst; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_dispatcher_email; ?></td>
              <td><input type="text" name="config_dispatcher_email" value="<?php echo $config_dispatcher_email; ?>" size="40" />
                <?php if ($error_email) { ?>
                <span class="error"><?php echo $error_dispatcher_email; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
