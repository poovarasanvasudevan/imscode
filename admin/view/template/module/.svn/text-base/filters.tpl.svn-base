    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
	    ...
	    <tr>
              ...
              <td><input type="text" name="filters_module[<?php echo $module_row; ?>][filters_title][<?php echo $language['language_id']; ?>]"  id="filters_title-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"   value="<?php echo isset($module['filters_title'][$language['language_id']]) ? $module['filters_title'][$language['language_id']] : ''; ?>" size="60" /></td>
            </tr>


              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="filters_module[<?php echo $module_row; ?>][filters_description][<?php echo $language['language_id']; ?>]" id="filters_description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['filters_description'][$language['language_id']]) ? $module['filters_description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
...
<?php foreach ($modules as $module) { ?>
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('filters_description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>', {
...
function addModule() {	
	...
	html += '          <td><input type="text" name="filters_module[<?php echo $module_row; ?>][filters_title][<?php echo $language['language_id']; ?>]"  id="filters_title-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"   value="<?php echo isset($module['filters_title'][$language['language_id']]) ? $module['filters_title'][$language['language_id']] : ''; ?>" size="60" /></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>	
	...
	html += '          <td><textarea name="filters_module[' + module_row + '][filters_description][<?php echo $language['language_id']; ?>]" id="filters_description-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	<?php foreach ($languages as $language) { ?>
	CKEDITOR.replace('filters_description-' + module_row + '-<?php echo $language['language_id']; ?>', {
		filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		filebrowserImageUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
