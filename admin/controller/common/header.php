...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_SHPT_reports'] = $this->language->get('text_SHPT_reports');
		$this->data['text_report_order_status_report'] = $this->language->get('text_report_order_status_report');
		$this->data['text_report_customer_wise_report'] = $this->language->get('text_report_customer_wise_report');
		$this->data['text_report_product_wise_report'] = $this->language->get('text_report_product_wise_report');
		...
		$this->data['text_invoicelist'] = $this->language->get('text_invoicelist');
		...
		$this->data['text_report_sales_order_details'] = $this->language->get('text_report_sales_order_details');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['invoicelist'] = $this->url->link('sale/invoice_list', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['report_sales_order_details'] = $this->url->link('report/sales_order_details', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_order_status_report'] = $this->url->link('report/order_status_report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_customer_wise_report'] = $this->url->link('report/customer_wise_order_report', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_product_wise_report'] = $this->url->link('report/product_wise_report', 'token=' . $this->session->data['token'], 'SSL');
