...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_dispatcher_email'] = $this->language->get('entry_dispatcher_email');		
		$this->data['entry_tin'] = $this->language->get('entry_tin');
		$this->data['entry_cst'] = $this->language->get('entry_cst');
		...
		if (isset($this->error['tin'])) {
			$this->data['error_tin'] = $this->error['tin'];
		} else {
			$this->data['error_tin'] = '';
		}
		
		if (isset($this->error['cst'])) {
			$this->data['error_cst'] = $this->error['cst'];
		} else {
			$this->data['error_cst'] = '';
		}
		...
		if (isset($this->request->post['config_tin'])) {
			$this->data['config_tin'] = $this->request->post['config_tin'];
		} else {
			$this->data['config_tin'] = $this->config->get('config_tin');
		}
		
		if (isset($this->request->post['config_cst'])) {
			$this->data['config_cst'] = $this->request->post['config_cst'];
		} else {
			$this->data['config_cst'] = $this->config->get('config_cst');
		}
		...
		if (isset($this->request->post['config_dispatcher_email'])) {
			$this->data['config_dispatcher_email'] = $this->request->post['config_dispatcher_email'];
		} else {
			$this->data['config_dispatcher_email'] = $this->config->get('config_dispatcher_email');
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_dispatcher_email']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['config_dispatcher_email'])) {
			$this->error['dispatcher_email'] = $this->language->get('error_email');
		}
