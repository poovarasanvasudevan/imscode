...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_subtitle_languages']       = $this->language->get('entry_subtitle_languages');
		$this->data['entry_no_of_tracks']       = $this->language->get('entry_no_of_tracks');
		$this->data['entry_no_of_discs']       = $this->language->get('entry_no_of_discs');
    ...
    if (isset($this->request->post['edition'])) {
        ...
        if (isset($this->request->post['subtitle_languages'])) {
                $this->data['subtitle_languages'] = $this->request->post['subtitle_languages'];
        } elseif (isset($product_info)) {
                        $this->data['subtitle_languages'] = $product_info['subtitle_languages'];
                } else {
                $this->data['subtitle_languages'] = '';
        }
		
		if (isset($this->request->post['no_of_tracks'])) {
                $this->data['no_of_tracks'] = $this->request->post['no_of_tracks'];
        } elseif (isset($product_info)) {
                        $this->data['no_of_tracks'] = $product_info['no_of_tracks'];
                } else {
                $this->data['no_of_tracks'] = '';
        }
		
		if (isset($this->request->post['no_of_discs'])) {
                $this->data['no_of_discs'] = $this->request->post['no_of_discs'];
        } elseif (isset($product_info)) {
                        $this->data['no_of_discs'] = $product_info['no_of_discs'];
                } else {
                $this->data['no_of_discs'] = '';
        }
